...
public:
  AvgAreaConstraint(size_t N, double_t &f, RefM3Xd x, RefM3Xd g)
...
public:
  AvgVolConstraint(size_t N, double_t &f, RefM3Xd x, RefM3Xd g)
      : ALConstraint(N, f, x, g) {}
  void compute();
};
...
public:
  ExactAreaConstraint(size_t N, double_t &f, RefM3Xd x, RefM3Xd g,
                      vtkSmartPointer<vtkPolyData> p)
      : ALConstraint(N, f, x, g) {
    _poly = p;
  }
  void compute();
...
public:
  ExactVolConstraint(size_t N, double_t &f, RefM3Xd x, RefM3Xd g,
                     vtkSmartPointer<vtkPolyData> p)
      : ALConstraint(N, f, x, g) {
    _poly = p;
  }
...
public:
  ExactAreaVolConstraint(size_t N, double_t &f, RefM3Xd x, RefM3Xd g,
                         vtkSmartPointer<vtkPolyData> p)
      : ALConstraint(N, f, x, g) {
    _poly = p;
    _area = 0.0;
