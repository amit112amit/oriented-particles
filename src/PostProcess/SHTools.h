...
extern "C" void shexpandlsq_wrapper_(double *cilm, double *d, double *lat,
                                     double *lon, int *N, int *lmax,
                                     double *chi2);

extern "C" void makegridpoints_wrapper_(double *cilm, int *lmax, int *n,
                                        double *lat, double *lon,
                                        double *points, int *dealloc);

extern "C" void glqgridcoord_wrapper_(double *latglq, double *longlq, int *lmax,
                                      int *nlat, int *nlong);

extern "C" void shglq_wrapper_(int *lmax, double *zero, double *w, double *plx);
