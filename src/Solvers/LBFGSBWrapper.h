...
public:
  //! Default Constructor
  LBFGSBParams()
      : _m(5), _iprint(1000), _maxIterations(100000), _factr(10.0),
        _pgtol(1e-8) {}

  //! Constructor with parameters
  LBFGSBParams(size_t m = 5, size_t i = 0, size_t mx = 1000, double_t f = 10,
               double_t p = 1.0e-5)
      : _m(m), _iprint(i), _maxIterations(mx), _factr(f), _pgtol(p) {}
